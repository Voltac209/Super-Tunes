...
<ul>
   <li><code>http://localhost:8080/</code> - basic frontend</li>
...
<p>
   The API gateway serves a small frontend at <code>/</code> for authentication,
   browsing songs, and managing playlists with a song catalogue picker.
</p>
